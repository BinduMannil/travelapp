    ...
    <section className="mx-auto max-w-[1180px] px-5 pt-16 lg:px-0">
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-3">
        {itinerary.map((day) => (
          ...
          >
            <ImageBackdrop src={day.image} alt={day.title} className="brightness-[0.82] saturate-[0.94] contrast-[1.04]" />
            ...
            <div className="relative z-10 p-6">
              ...
              <h3 className="mt-4 max-w-[14rem] font-sans text-3xl font-semibold leading-[1.05] text-[#fff7e5] drop-shadow-[0_2px_16px_rgba(0,0,0,.96)]">
                {day.title}
              </h3>
